...
namespace UI.Settigns
{
    ...
    {
        private const string KEY_NOTIFICATIONS = "Notifications";
        ...
        private void Awake()
        {
            ...
            _notificationsState = PlayerPrefs.GetInt(KEY_NOTIFICATIONS, 1) == 1;
            _vibrationsState = PlayerPrefs.GetInt(KEY_NOTIFICATIONS, 1) == 1;
        }
        ...
        private void InitToggles()
        {
            ...
            if (_vibrationsState)
            {
                ...
                PlayerPrefs.SetInt(KEY_VIBRATIONS, 1);
            }
            else
            {
                _vibrationsImage.sprite = _offSprite;
                _vibrationsHandlerRect.anchoredPosition = new(_offTogglePostionX, 0f);
                PlayerPrefs.SetInt(KEY_VIBRATIONS, 0);
            }

            PlayerPrefs.Save();
            Debug.Log($"Notifications state: {PlayerPrefs.GetInt(KEY_NOTIFICATIONS)} / Vibrations state: {PlayerPrefs.GetInt(KEY_VIBRATIONS)}");
        }
